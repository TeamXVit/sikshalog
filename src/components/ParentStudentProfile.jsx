...
const ParentStudentProfile = () => {
  ...
  // Mock data for the two children
  const studentsData = {
    1: {
      id: 1,
      name: 'Devansh Gupta',
      ...
      address: '456, Nehru Colony, Rural District, State - 123456',
      ...
      achievements: [
        'Mathematics Olympiad Winner 2024',
        'School Science Fair 1st Prize',
        'Best Student of the Month - March 2024'
      ],
      attendanceHistory: [
        { date: '2024-01-15', status: 'present', sessions: ['Morning', 'Afternoon'] },
        { date: '2024-01-16', status: 'present', sessions: ['Morning', 'Afternoon'] },
        { date: '2024-01-17', status: 'present', sessions: ['Morning', 'Afternoon'] },
    ...
    2: {
      ...
      currentMonthAttendance: 88,
      grades: [
        { subject: 'Mathematics', marks: 82, grade: 'A' },
        { subject: 'Science', marks: 85, grade: 'A' },
        { subject: 'English', marks: 90, grade: 'A+' },
        { subject: 'Hindi', marks: 88, grade: 'A' },
        { subject: 'Social Studies', marks: 84, grade: 'A' }
      ],
      achievements: [
        'English Poetry Competition Winner',
        'Art Competition 2nd Prize',
      ...
      attendanceHistory: [
        ...
        { date: '2024-01-18', status: 'present', sessions: ['Morning', 'Afternoon'] },
        { date: '2024-01-19', status: 'present', sessions: ['Morning', 'Afternoon'] }
      ]
    }
  };

  // Convert studentId to number and get student data
  const student = studentsData[parseInt(studentId)] || studentsData[1];
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            ...
            className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 hover:bg-blue-50 px-3 py-2 rounded-lg transition-colors duration-200"
          >
